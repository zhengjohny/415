...
Router.map(function () {
	...
	this.route("kitties", {path: "/kitties", controller: "KittiesController"});
	this.route("kitties.insert", {path: "/kitties/insert", controller: "KittiesInsertController"});
	this.route("about_public", {path: "/about_public", controller: "AboutPublicController"});
	...
	this.route("kitties_private", {path: "/kitties_private", controller: "KittiesPrivateController"});
	this.route("about_private", {path: "/about_private", controller: "AboutPrivateController"});
